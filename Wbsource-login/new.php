...
echo "        <h1 class=\"text-light\"><a href=\"#intro\" class=\"scrollto\"><span>SAFE CITY</span></a></h1>\n";
echo "        \n";
echo "      </div>\n";
echo "\n";
echo "      <nav class=\"main-nav float-right d-none d-lg-block\">\n";
echo "        <ul>\n";
echo "          <li><a href=\"./../Map/map1.php\">Explore The Map</a></li>\n";
echo "          <li><a href=\"#\">Submit a Tip</a></li>\n";
echo "          <li class=\"active\"><a href=\"#\">Law Enforcement-Join Free</a></li>\n";
...
echo "          <h2>Bhopal<br>for a better <span>tomorrow</span></h2>\n";
echo "          <div>\n";
echo "            <a href=\"./../Map/map.html\" class=\"btn-get-started scrollto\">Explore Map</a>\n";
echo "          </div>\n";
echo "        </div>\n";
echo "  \n";
echo "        <div class=\"col-md-6 intro-img order-md-last order-first\">\n";
echo "          <img src=\"img/intro-img.svg\" alt=\"\" class=\"img-fluid\">\n";
echo "        </div>\n";
echo "      </div>\n";
echo "\n";
echo "    </div>\n";
